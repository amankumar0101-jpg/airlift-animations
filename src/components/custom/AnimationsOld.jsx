...
// // // // // //         </div>
// // // // // //         {/* Gif Part */}
// // // // // //         <div className="h-[180px] w-[130px] object-fill overflow-hidden flex items-center justify-center opacity-45 transform-gpu rotate-[-90deg]">
// // // // // //           <img
// // // // // //             src={PlugGif}
// // // // // //             alt="Performance Empty"
// // // // // //             className="w-full object-cover rounded-[4px] h-[180px]"
// // // // // //           />
// // // // // //         </div>
...
// // // // // //       <div className="min-w-[458px] w-full max-w-[458px] min-h-[540px] h-full max-h-[540px] border-[0.91px] border-solid border-zinc-200 rounded-[36px] relative bg-white flex flex-col items-center  overflow-hidden">
// // // // // //         <div
// // // // // //           className={`w-full h-full flex flex-col ${dynamicSpacing} items-center grow justify-start relative`}
// // // // // //         >
// // // // // //           {/* Absolute Con with bg */}
// // // // // //           <div className="flex w-full h-full items-center justify-center absolute top-0 left-0 pointer-events-none select-none">
// // // // // //             <div className="flex min-w-[353.76px] w-full max-w-[353.76px] min-h-[443.4px] h-full max-h-[443.4px] bg-[conic-gradient(from_43.24deg_at_24.88%_66.33%,rgba(99,102,241,0.5)_-3.37deg,\#C7D2FE_54.89deg,rgba(165,243,252,0.65)_63.64deg,\#FFFFFF_182.15deg,\#67E8F9_236.56deg,rgba(99,102,241,0.5)_356.63deg,\#C7D2FE_414.89deg)] opacity-60 transform-gpu rotate-[-155.51deg]"></div>
...
// // // // //     1: "gap-9 py-[60px]",
// // // // //     2: "gap-0 pt-[38px] px-9",
// // // // //     3: "px-10 py-[calc(46.71px-0.91px)] gap-0",
// // // // //     4: "gap-4 py-8",
// // // // //     5: "gap-6 py-12",
// // // // //   };
...
// // // // //         </div>
// // // // //         {/* Con Part */}
// // // // //         <div className="flex flex-col bg-white items-center w-full grow gap-[38px] relative">
// // // // //           {/* Overlay Blur Effect: separate elements for ON vs OFF flows */}
// // // // //           {/* ON flow: expand (44 -> 100), then after delay set optimize=true and fade out */}
// // // // //           {overlayVisible && airliftEnabled ? (
// // // // //             <div
...
// // // // //           />
// // // // //         </div>
// // // // //         <div className="w-[386px] h-[437px] grow bg-white z-20">
// // // // //           <img
// // // // //             src={InstallStep}
// // // // //             alt="Installation Step"
...
// // // // //           <div className="absolute top-[-3px] left-[-3px] w-[6.34px] h-[6.34px] bg-indigo-200"></div>
// // // // //           <div className="absolute top-[-3px] right-[-3px] w-[6.34px] h-[6.34px] bg-indigo-200"></div>
// // // // //           <div className="absolute bottom-[-3px] left-[-3px] w-[6.34px] h-[6.34px] bg-indigo-200"></div>
// // // // //           <div className="absolute bottom-[-3px] right-[-3px] w-[6.34px] h-[6.34px] bg-indigo-200"></div>
...
// // // //         // small initial delay (.3s) before starting border draw and mark analyzed
// // // //         const t0 = setTimeout(() => {
// // // //           setNoBorderTransition(false); // ensure transitions enabled
// // // //           setAnimateBorders(true);
// // // //           setImageAnalyzed(true);
// // // //         }, 300);

// // // //         // after 5s from start => mark optimized (user wanted 5s)
// // // //         const t1 = setTimeout(() => {
// // // //           setImageOptimized(true);
// // // //         }, 5000 + 300); // align with initial offset

// // // //         // after 10s from start => instantly hide borders and reset states
// // // //         const t2 = setTimeout(() => {
// // // //           setNoBorderTransition(true); // remove with no transition
// // // //           setAnimateBorders(false); // collapse instantly because transition: none
// // // //           setImageAnalyzed(false);
// // // //           setImageOptimized(false);
// // // //         }, 10000 + 300);

// // // //         // after 15s from start => clear noTransition and restart cycle
// // // //         const t3 = setTimeout(() => {
// // // //           setNoBorderTransition(false);
// // // //           startCycle(); // loop
// // // //         }, 15000 + 300);

// // // //         borderTimersRef.current.push(t0, t1, t2, t3);
// // // //       };
...
// // // //     // if step changed away from 3, ensure timers are cleared and states reset
// // // //     return () => {
// // // //       borderTimersRef.current.forEach((t) => clearTimeout(t));
// // // //       borderTimersRef.current = [];
// // // //       setAnimateBorders(false);
...
// // //     2: "gap-0 pt-[38px] px-9 justify-start",
...
// // //           {/* Textbox 1*/}
// // //           <div className="flex flex-row gap-2 min-w-[167.89px] w-full max-w-[167.89px] min-h-[69px] h-full max-h-[69px] border-[0.91px] border-[#E4E4E7] rounded-[16px] py-[calc(16px-0.91px)] pr-[12.35px] pl-[16px]">
// // //             <Type size={14.54} strokeWidth={1.36} className="text-indigo-800" />
// // //             {/* text container */}
// // //             <div className="flex flex-col gap-2">
// // //               <p className="text-[12.72px] leading-[100%] text-zinc-800">
// // //                 Inter-Regular
...
// // //           {/* Textbox 2*/}
// // //           <div className="flex flex-row gap-2 min-w-[171.89px] w-full max-w-[171.89px] min-h-[69px] h-full max-h-[69px] border-[0.91px] border-[#E4E4E7] rounded-[16px] py-[calc(16px-0.91px)] pr-[12.35px] pl-[16px]">
// // //             <Type size={14.54} strokeWidth={1.36} className="text-indigo-800" />
// // //             {/* text container */}
// // //             <div className="flex flex-col gap-2">
// // //               <p className="text-[12.72px] leading-[100%] text-zinc-800">
...
// // //           {/* Textbox 1*/}
// // //           <div className="flex flex-row gap-2 min-w-[183.89px] w-full max-w-[183.89px] min-h-[69px] h-full max-h-[69px] border-[0.91px] border-[#E4E4E7] rounded-[16px] py-[calc(16px-0.91px)] pr-[12.35px] pl-[16px]">
// // //             <Type size={14.54} strokeWidth={1.36} className="text-indigo-800" />
// // //             {/* text container */}
// // //             <div className="flex flex-col gap-2">
// // //               <p className="text-[12.72px] leading-[100%] text-zinc-800">
...
// // //           {/* Textbox 2*/}
// // //           <div className="flex flex-row gap-2 min-w-[162.89px] w-full max-w-[162.89px] min-h-[69px] h-full max-h-[69px] border-[0.91px] border-[#E4E4E7] rounded-[16px] py-[calc(16px-0.91px)] pr-[12.35px] pl-[16px]">
// // //             <Type size={14.54} strokeWidth={1.36} className="text-indigo-800" />
// // //             {/* text container */}
// // //             <div className="flex flex-col gap-2">
// // //               <p className="text-[12.72px] leading-[100%] text-zinc-800">
...
// // //           {/* Textbox 3*/}
// // //           <div className="flex flex-row gap-2 min-w-[175.89px] w-full max-w-[175.89px] min-h-[69px] h-full max-h-[69px] border-[0.91px] border-[#E4E4E7] rounded-[16px] py-[calc(16px-0.91px)] pr-[12.35px] pl-[16px]">
// // //             <Type size={14.54} strokeWidth={1.36} className="text-indigo-800" />
// // //             {/* text container */}
// // //             <div className="flex flex-col gap-2">
// // //               <p className="text-[12.72px] leading-[100%] text-zinc-800">
...
// // //           {/* Textbox 2*/}
// // //           <div className="flex flex-row gap-2 min-w-[198.89px] w-full max-w-[198.89px] min-h-[69px] h-full max-h-[69px] border-[0.91px] border-[#E4E4E7] rounded-[16px] py-[calc(16px-0.91px)] pr-[12.35px] pl-[16px]">
// // //             <Type size={14.54} strokeWidth={1.36} className="text-indigo-800" />
// // //             {/* text container */}
// // //             <div className="flex flex-col gap-2">
// // //               <p className="text-[12.72px] leading-[100%] text-zinc-800">
...
// // //           {/* Textbox 3*/}
// // //           <div className="flex flex-row gap-2 min-w-[206.89px] w-full max-w-[206.89px] min-h-[69px] h-full max-h-[69px] border-[0.91px] border-[#E4E4E7] rounded-[16px] py-[calc(16px-0.91px)] pr-[12.35px] pl-[16px]">
// // //             <Type size={14.54} strokeWidth={1.36} className="text-indigo-800" />
// // //             {/* text container */}
// // //             <div className="flex flex-col gap-2">
// // //               <p className="text-[12.72px] leading-[100%] text-zinc-800">
...
// // //           {/* Textbox 1*/}
// // //           <div className="flex flex-row gap-2 min-w-[165.89px] w-full max-w-[165.89px] min-h-[69px] h-full max-h-[69px] border-[0.91px] border-[#E4E4E7] rounded-[16px] py-[calc(16px-0.91px)] pr-[12.35px] pl-[16px]">
// // //             <Type size={14.54} strokeWidth={1.36} className="text-indigo-800" />
// // //             {/* text container */}
// // //             <div className="flex flex-col gap-2">
// // //               <p className="text-[12.72px] leading-[100%] text-zinc-800">
...
// // //           {/* Textbox 2*/}
// // //           <div className="flex flex-row gap-2 min-w-[144.89px] w-full max-w-[144.89px] min-h-[69px] h-full max-h-[69px] border-[0.91px] border-[#E4E4E7] rounded-[16px] py-[calc(16px-0.91px)] pr-[12.35px] pl-[16px]">
// // //             <Type size={14.54} strokeWidth={1.36} className="text-indigo-800" />
// // //             {/* text container */}
// // //             <div className="flex flex-col gap-2">
// // //               <p className="text-[12.72px] leading-[100%] text-zinc-800">
...
// // //         <div className="flex flex-col absolute items-end left-0 w-[156px] min-h-[468px] h-full max-h-[468px]">
// // //           <div className="min-w-[146.54px] w-full max-w-[146.54px] relative h-full">
// // //             {/* Loader Box */}
// // //             <div className="flex flex-row gap-1.5 mx-[10.79px] justify-between min-w-[146.54px] w-full max-w-[146.54px] min-h-[52px] h-full max-h-[52px] border-[0.91px] border-solid border-zinc-100 rounded-[8px] p-[calc(8px-0.91px)] shadow-[0px_9.09px_9.09px_-4.54px_#0000000A,0px_18.17px_22.72px_-4.54px_#0000001A]">
// // //               <LoaderCircle
// // //                 size={14.54}
// // //                 strokeWidth={1.36}
// // //                 className="shrink-0 text-indigo-700 animate-spin"
...
// // //             <div></div>
// // //             {/* Loader Line */}
// // //             <div className="min-w-[43.62px] w-full max-w-[43.62px] min-h-[376.21px] h-full max-h-[376.21px] border-r-[1px] border-indigo-700 backdrop-blur-[3px]">
// // //               <img
// // //                 src={Blurbg}
// // //                 alt="bg blur"
// // //                 className="w-full h-full object-cover"
...
// // //             {/* Loader Bottom icon */}
// // //             <div className="flex flex-col justify-center items-center min-w-[39.32px] w-full max-w-[39.32px] min-h-[37.81px] h-full max-h-[37.81px] border-[0.91px] border-solid border-zinc-100 rounded-[8px] shadow-[0px_9.09px_9.09px_-4.54px_#0000000A,0px_18.17px_22.72px_-4.54px_#0000001A] ml-[23px]">
// // //               <img
// // //                 src={Bluricons}
// // //                 alt="Blur Icon"
...
// //         {/* Loader Absolute Section */}
// //         <div className="flex flex-col items-end absolute left-0  w-[156px] min-h-[468px] h-full max-h-[468px]">
// //           <div className="w-[156px] relative h-full">
// //             {/* Loader Box */}
...
//             }, 3000);
//             loaderTimersRef.current.push(t2);
//           }, 5000);
...
//             {/* Loader Line */}
//             <div className="w-[43.62px] items-end">
//               <div className="min-w-[43.62px] w-full max-w-[43.62px] min-h-[376.21px] h-full max-h-[376.21px] border-r-[1px] border-indigo-700 backdrop-blur-[3px]">
//                 <img
//                   src={Blurbg}
//                   alt="bg blur"
    ...
    return (
      <>
        ...
        >
          ...
          >
            <div className="w-full min-h-[376.21px] h-full max-h-[376.21px] border-r-[1px] border-indigo-700 backdrop-blur-[3px] flex flex-col justify-center items-end">
